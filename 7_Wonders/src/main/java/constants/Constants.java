...
public class Constants {
	...
	public static final Point TradeLeftBaseButtonPoint = new Point(LastPlayerBoardPositionX - 5,
	...
	public static final int PlayerHandLeftMostCardPositionY = CurrentPlayerBoardPositionY + CurrentPlayerBoardHeight
			- CardHeight - 100;
	...
	public static final int RESOURCE_VIEWER_CELL_WIDTH = (RESOURCE_VIEWER_ROW_WIDTH - RESOURCE_VIEWER_FIRST_CELL_WIDTH)
			/ 13;
	...
	public static final int RESOURCE_VIEWER_FIVE_COIN_X = RESOURCE_VIEWER_ONE_COIN_X;
	public static final int RESOURCE_VIEWER_FIVE_COIN_Y = RESOURCE_VIEWER_ONE_COIN_Y + 6 * RESOURCE_VIEWER_ROW_HEIGHT;

	public static final int RESOURCE_VIEWER_VICTORY_POINTS_X = RESOURCE_VIEWER_SHIELD_X;
	public static final int RESOURCE_VIEWER_VICTORY_POINTS_Y = RESOURCE_VIEWER_SHIELD_Y
			+ 6 * RESOURCE_VIEWER_ROW_HEIGHT;
