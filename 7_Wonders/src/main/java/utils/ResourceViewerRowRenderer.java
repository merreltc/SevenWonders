...
public class ResourceViewerRowRenderer {
	...
	private void drawShieldBox() {
		...
		this.renderer.draw(graphics,
				new int[] { Constants.RESOURCE_VIEWER_SHIELD_X + Constants.RESOURCE_VIEWER_CELL_WIDTH / 3,
		...
		graphics.drawString(player.getNumShields() + "",
				...
				Constants.RESOURCE_VIEWER_SHIELD_Y + Constants.RESOURCE_VIEWER_TEXT_Y_OFFSET
